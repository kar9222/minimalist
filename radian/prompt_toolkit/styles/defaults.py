...
PROMPT_TOOLKIT_STYLE = [
    ...
    # Incremental search.
    ('incsearch',                          ''),
    # CUSTOM: prev val 'reverse' 
    ('incsearch.current',                  'bg:ansibrightblack #f8f8f2'),
    ...
    # Search toolbar.
    # CUSTOM 
    ('search-toolbar',                          'ansiblack'),
    ('search-toolbar.text',                     'ansibrightcyan'),
    ...
    # Completions menu.
    # CUSTOM 
    ('completion-menu',                         'bg:default #f8f8f2'),
    ('completion-menu.completion',              ''),
    # ('completion-menu.completion.current',      'bg:ansimagenta'),
    ('completion-menu.completion.current',      'ansiyellow'),
    ...
    # CUSTOM 
    # NOTE Intended 'fg' color is 'ansiyellow' but weirdly it renders another color, hence 'ansibrightmagenta' is used.
    ('completion-menu.completion fuzzymatch.outside',          '#f8f8f2'),
    ('completion-menu.completion fuzzymatch.inside',           'bold ansibrightgreen'),
    ('completion-menu.completion fuzzymatch.inside.character', ''),
    ('completion-menu.completion.current fuzzymatch.outside',  'ansibrightmagenta'),
    ('completion-menu.completion.current fuzzymatch.inside',   'bold ansibrightmagenta'),
    ...
    # Scrollbars.
    # CUSTOM 
    ('scrollbar.background',                     'bg:#282c35'),
    ...
    # CUSTOM 
    ('aborting',  'ansibrightblack bg:default noreverse noitalic nounderline noblink'),
    ('exiting',   'ansibrightblack bg:default noreverse noitalic nounderline noblink'),
